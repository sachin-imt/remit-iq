                ...
                <div className="mx-auto max-w-6xl px-4 relative">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex gap-4">
                            <Link href="/calculators" className="text-[#00B9FF] text-sm font-semibold hover:text-white transition-colors flex items-center gap-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-6">
                            <h2 className="text-white font-bold text-lg mb-6">Loan Details</h2>

                            {/* Amount */}
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[#7A9CC4] text-sm font-medium">Loan Amount</label>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-[#0D1B2E] border border-[#1E3A5F] rounded-xl py-3 px-4 pl-8 text-white font-semibold focus:outline-none focus:border-[#00B9FF] transition-all"
                                    />
                                </div>
                                <input
                                    type="range"
                                    ...
                                    value={amount}
                                    onChange={handleAmountChange}
                                    className="w-full h-1.5 bg-[#1E3A5F] rounded-lg appearance-none cursor-pointer mt-4 accent-[#00B9FF]"
                                />
                            </div>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[#7A9CC4] text-sm font-medium">Interest Rate (APR)</label>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        step="0.1"
                                        className="w-full bg-[#0D1B2E] border border-[#1E3A5F] rounded-xl py-3 px-4 pr-8 text-white font-semibold focus:outline-none focus:border-[#00B9FF] transition-all"
                                    />
                                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[#7A9CC4] font-semibold">%</span>
                                </div>
                                <input
                                    type="range"
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[#7A9CC4] text-sm font-medium">Loan Term</label>
                                    <span className="text-white font-bold">{years} {years === 1 ? 'Year' : 'Years'}</span>
                                </div>
                        ...
                        <div className="bg-gradient-to-br from-[#F0B429]/10 to-[#00B9FF]/10 border border-[#1E3A5F] rounded-2xl p-5">
                            <div className="flex items-start gap-3">
                                <div className="pt-1"><CheckCircle2 className="w-5 h-5 text-[#F0B429]" /></div>
                                <div>
                                    <h3 className="text-white font-semibold text-sm mb-1">Sending loan funds globally?</h3>
                    ...
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-5 relative overflow-hidden group">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#00B9FF]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                                <p className="text-[#7A9CC4] text-xs font-semibold uppercase tracking-wider mb-2">Monthly Payment</p>
                            ...
                            <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-5 relative overflow-hidden group">
                                ...
                                <p className="text-[#7A9CC4] text-xs font-semibold uppercase tracking-wider mb-2">Total Interest</p>
                            ...
                            <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-5 relative overflow-hidden group">
                                ...
                                <p className="text-[#7A9CC4] text-xs font-semibold uppercase tracking-wider mb-2">Total Paid</p>
                                <p className="text-2xl font-bold text-white">
                        ...
                        <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-6">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-[#7A9CC4] text-sm">Principal balance vs cumulative interest over time</p>
                                </div>
                            </div>
                      ...
                      />
                            ...
                            <div className="flex items-center justify-center gap-6 mt-6 pt-4 border-t border-[#1E3A5F]/50">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs text-[#7A9CC4] font-medium">Remaining Balance</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-[#F43F5E]"></div>
                                    <span className="text-xs text-[#7A9CC4] font-medium">Cumulative Interest</span>
                                </div>
                            </div>
                        </div>

                        {/* Information Tips */}
                        <div className="bg-[#00B9FF]/5 border border-[#00B9FF]/20 rounded-2xl p-5 flex items-start gap-4">
                            <div className="mt-1"><Info className="w-5 h-5 text-[#00B9FF]" /></div>
                            <div>
                                <h4 className="text-white font-semibold text-sm mb-1">How Loans Work</h4>
