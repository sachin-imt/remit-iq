...
function Section({ id, title, children }: { id?: string; title: string; children: React.ReactNode }) {
    return (
        <section id={id} className="mb-12">
            <h2 className="text-2xl font-bold mb-4" style={{ color: '#334155' }}>{title}</h2>
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <Section title="2. Information We Collect">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-2">
                        <li><strong style={{ color: '#334155' }}>Email address</strong> — collected only when you voluntarily sign up for rate alerts. Used solely to send you exchange rate notifications.</li>
                        <li><strong style={{ color: '#334155' }}>Rate alert preferences</strong> — the target exchange rate and alert type you set when creating an alert.</li>
                        <li><strong style={{ color: '#334155' }}>Analytics data</strong> — anonymised usage data (page views, device type, country) collected via Vercel Analytics, only if you consent via our cookie banner. No personally identifiable information is collected by analytics.</li>
                    </ul>
                    <p>We do <strong style={{ color: '#334155' }}>not</strong> collect: financial account details, identity documents, payment information, or sensitive personal information.</p>
                </Section>

                <Section title="3. Legal Basis for Processing">
                    <p>We process your data under the following legal bases:</p>
                    <ul className="list-disc list-inside space-y-2 ml-2">
                        <li><strong style={{ color: '#334155' }}>Consent</strong> — for rate alert emails (you opt in by submitting the alert form) and analytics cookies (you opt in via the cookie consent banner).</li>
                        <li><strong style={{ color: '#334155' }}>Legitimate interest</strong> — for operating and improving our service, detecting fraud, and ensuring security.</li>
                    </ul>
                ...
                <Section title="4. How We Use Your Information">
                    ...
                    <p>We <strong style={{ color: '#334155' }}>never</strong> sell, rent, or share your personal data with third parties for marketing purposes. Our rankings are based solely on the total INR you receive and are never influenced by commercial relationships.</p>
                </Section>
                ...
                <Section title="5. Third-Party Services">
                    ...
                    <div className="space-y-3 mt-3">
                        <div className="rounded-lg p-4" style={{ backgroundColor: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                            <p><strong style={{ color: '#334155' }}>Vercel Analytics</strong> — anonymised website analytics (page views, device type, geography). No personal data is sent. Data processed in the United States. <a href="https://vercel.com/docs/analytics/privacy-policy" className="underline" style={{ color: "#F0B429" }}>Vercel Privacy Policy</a></p>
                        </div>
                        <div className="rounded-lg p-4" style={{ backgroundColor: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                            <p><strong style={{ color: '#334155' }}>Resend</strong> — transactional email delivery for rate alerts and verification codes. Your email address is shared with Resend solely to deliver emails. Data processed in the United States. <a href="https://resend.com/legal/privacy-policy" className="underline" style={{ color: "#F0B429" }}>Resend Privacy Policy</a></p>
                        </div>
                        <div className="rounded-lg p-4" style={{ backgroundColor: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                            <p><strong style={{ color: '#334155' }}>Wise API &amp; Frankfurter API</strong> — exchange rate data sources. No personal user data is sent to these services.</p>
                        </div>
                    </div>
                </Section>
                ...
                <Section title="6. Cookies & Tracking">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-2">
                        <li><strong style={{ color: '#334155' }}>Cookie consent preference</strong> — stored in your browser&apos;s localStorage (not a cookie). Records whether you accepted or rejected analytics tracking.</li>
                        <li><strong style={{ color: '#334155' }}>Vercel Analytics</strong> — only loaded if you click &quot;Accept&quot; on the cookie consent banner. Collects anonymised usage data. No analytics data is collected if you reject.</li>
                    </ul>
                ...
                <Section title="7. Data Retention">
                    <ul className="list-disc list-inside space-y-2 ml-2">
                        <li><strong style={{ color: '#334155' }}>Rate alerts</strong> — retained until the alert is triggered or you request deletion. Triggered alerts are deactivated but the record is kept for 90 days before automatic purging.</li>
                        <li><strong style={{ color: '#334155' }}>Analytics data</strong> — retained by Vercel in accordance with their data retention policies (typically up to 26 months).</li>
                        <li><strong style={{ color: '#334155' }}>Verification codes</strong> — expire automatically after 10 minutes and are not retained beyond that.</li>
                    </ul>
                </Section>
                ...
                <section id="manage" className="mb-12">
                    <div className="rounded-lg p-8 border" style={{ backgroundColor: '#F8FAFC', borderColor: '#E2E8F0' }}>
                ...
                <Section title="11. Contact Us">
                    ...
                    <div className="rounded-lg p-4 mt-3" style={{ backgroundColor: '#F8FAFC', border: '1px solid #E2E8F0' }}>
                        <p><strong style={{ color: '#334155' }}>RemitIQ Privacy Team</strong></p>
                        ...
                        <p className="mt-1"><strong style={{ color: '#334155' }}>Office of the Australian Information Commissioner (OAIC)</strong></p>
