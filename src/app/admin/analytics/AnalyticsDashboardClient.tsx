            ...
            <div className="mx-auto max-w-7xl px-4 py-8 space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-6">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <span className="text-xs text-[#7A9CC4] ml-auto">Last 30 days</span>
                        </div>
                                    ...
                                    return (
                                        <div key={i}>
                                            <div className="flex justify-between items-baseline mb-1">
                                                <span className="text-sm text-[#C8D8E8] truncate max-w-[200px]">{page.page_path}</span>
                    ...
                    <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="mt-4 pt-4 border-t border-[#1E3A5F]">
                                <div className="flex items-center gap-2 text-[#7A9CC4]">
                ...
                <div className="bg-[#111D32] border border-[#1E3A5F] rounded-2xl p-6">
                    <div className="flex items-center gap-2 mb-5">
                        ...
                        <span className="text-xs text-[#7A9CC4] ml-auto">Last 50</span>
                    </div>
