        ...
        <header className="sticky top-0 z-50 border-b border-[#1E3A5F] bg-[#0A1628]/95 backdrop-blur-md">
          <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm">
              <a href="/" className="text-[#7A9CC4] hover:text-white transition-colors">Compare Rates</a>
              <a href="/calculators" className="text-[#7A9CC4] hover:text-white transition-colors">Calculators</a>
          ...
          <div className="mx-auto max-w-6xl px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-[#7A9CC4] text-sm leading-relaxed">Smarter remittances start here. Compare rates, get timing intelligence, and empower your financial decisions with our suite of free tools.</p>
              </div>
              <div><h3 className="text-white font-semibold mb-3 text-sm">Tools</h3><ul className="space-y-2 text-sm text-[#7A9CC4]"><li><a href="/" className="hover:text-white">Rate Comparison</a></li><li><a href="/calculators" className="hover:text-white">Finance Calculators</a></li><li><a href="/alerts" className="hover:text-white">Rate Alerts</a></li></ul></div>
