            ...
            <div className="mx-auto max-w-6xl px-4">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-200 mb-6">
                        ...
                        <span className="text-slate-700 text-sm font-medium">RemitIQ B2B API v1.0</span>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-20">
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                        <div className="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center mb-4 border border-slate-200">
                            <Zap className="w-6 h-6 text-[#F0B429]" />
                        </div>
                        <h3 className="text-xl font-bold text-slate-900 mb-2">Real-Time Aggregation</h3>
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-2">Historical Backtesting</h3>
                        <p className="text-slate-500 text-sm leading-relaxed">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-2">Proprietary AI Signals</h3>
                        <p className="text-slate-500 text-sm leading-relaxed">
                ...
                {/* Code Snippet */}
                <div className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden mb-20 shadow-2xl">
                    <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-200 bg-slate-50">
                        ...
                        <span className="ml-4 text-xs font-mono text-slate-500">curl snippet</span>
                    </div>
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500">Start building for free. Upgrade when you need production scale.</p>
                </div>

                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {/* Free Tier */}
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 flex flex-col h-full">
                        <h3 className="text-2xl font-bold text-slate-900 mb-2">Sandbox</h3>
                        <p className="text-slate-500 text-sm mb-6">Perfect for prototyping and testing.</p>
                        ...
                        <ul className="space-y-4 mb-8 flex-1 text-slate-700 text-sm">
                        ...
                        <a href="mailto:api@remitiq.co" className="w-full block text-center bg-transparent border-2 border-slate-200 hover:border-[#F0B429] text-slate-900 font-bold py-3 px-6 rounded-xl transition-all">
                            Get Sandbox Key
                        </a>
                    </div>

                    {/* Pro Tier */}
                    <div className="bg-white border-2 border-[#F0B429] rounded-2xl p-8 flex flex-col h-full relative">
                        <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-[#F0B429] text-slate-900 text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wide">
                            Most Popular
                        </div>
                        <h3 className="text-2xl font-bold text-slate-900 mb-2">Production API</h3>
                        <p className="text-slate-500 text-sm mb-6">For businesses power cross-border payments.</p>
                        ...
                        <a href="mailto:api@remitiq.co" className="w-full block text-center bg-[#F0B429] hover:bg-yellow-400 text-slate-900 font-bold py-3 px-6 rounded-xl transition-all shadow-lg glow-gold">
                            Request Access
                        </a>
                    </div>
                </div>
